        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="mt-4">
                <div className="text-sm text-gray-600">
                  Pages with issues: <span className="font-medium text-red-600">{stats.pagesWithIssues}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="mt-4">
                <div className="text-sm text-gray-600">
                  Missing alt text: <span className="font-medium text-orange-600">{stats.imagesWithoutAlt}</span>
                </div>
              </div>
            </div>
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">
                      {stats.pagesWithIssues + stats.imagesWithoutAlt + stats.brokenImages}
                    </dd>
                  </dl>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {auditResults.pages.slice(0, 10).map((page, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        <td className="px-6 py-4 text-sm text-gray-900 max-w-xs truncate">
                          <a href={page.url} target="_blank" rel="noopener noreferrer" className="hover:text-primary-600">
                            {page.url}
                          </a>
                        </td>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 max-w-xs">
                          <div className="truncate" title={page.titleOriginal}>
                            {page.titleOriginal || 'Missing'}
                          </div>
                          {page.titleSuggested && (
                            <div className="text-xs text-gray-500 truncate" title={page.titleSuggested}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            page.h1Valid === 'Yes' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                          }`}>
              ...
              {auditResults.pages.length > 10 && (
                <div className="px-6 py-3 bg-gray-50 text-sm text-gray-500">
                  Showing 10 of {auditResults.pages.length} pages. Download full report for complete results.
                </div>
              )}
            </div>
          </div>
